...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'FHome', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'HolyKuma', // 作者简介
  ...
  // RSS订阅
  ENABLE_RSS: process.env.NEXT_PUBLIC_ENABLE_RSS || fasle, // 是否开启RSS订阅功能
  ...
  GREETING_WORDS:
    ...
    'Hi，Welcome to FHome, Hi,欢迎来到FHome🎉',
